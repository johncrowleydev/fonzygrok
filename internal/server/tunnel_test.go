...
func TestRegister(t *testing.T) {
	...
	if assignment.AssignedSubdomain != assignment.TunnelID {
		t.Errorf("subdomain should equal tunnel ID: got %q", assignment.AssignedSubdomain)
	}
	...
	expectedURL := "http://" + assignment.TunnelID + ".tunnel.test.com"
